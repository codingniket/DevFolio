        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex w-full flex-col gap-3">
              ...
              <FormControl className="mt-3.5">
                {/* Adding all the code for tiny editor in this project */}
                <Editor
                  ...
                  {field.value.length > 0 && (
                    <div className="flex-start mt-2.5 gap-2.5">
                      {field.value.map((tag: any) => (
                        ...
                        background-light800_dark300 flex 
                        items-center justify-center gap-2 rounded-md border-none 
                        px-4 py-2 capitalize text-light-500
                        "
